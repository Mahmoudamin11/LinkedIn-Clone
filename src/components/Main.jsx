...
const Main = (props) => {
    ...
    // handle upload a post (Opens the model)
    const handleClick = () => { 
    ...
    return (
        <Container>
            ...
            {
                props.articles.length === 0 ? (<NoPostsMsg>There are no posts yet</NoPostsMsg>)
                : 
                (
                    <Content>
                        {props.loading && <img src='/images/loader.svg' alt='Loading' />}
                        {
                                    ...
                                    <SharedActor>
                                        <a>
                                            ...
                                            <div>
                                                ...
                                                <span>
                                                    {new Date(article.actor.date).toLocaleDateString()}
                                                </span>
                                            </div>
                                        </a>
                                        <button>
